        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if( answer.answer.Count == count) 
            {
                ...
                for (int i = 0;i < wrong_answers.Count;i++)
                {
                    ...
                    MessageBox.Show($"Ошибка в вопросе {test.Quest_text[wrong_answers[i]]} Правельный ответ:{right_answers.ToString()}", "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    this.Close();
                    mainView.Show();
                }
